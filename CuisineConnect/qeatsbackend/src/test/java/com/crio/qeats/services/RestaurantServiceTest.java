...
class RestaurantServiceTest {
  ...
  void peakHourServingRadiusOf3KmsAt7Pm() throws IOException {
    assertEquals("3.0", getServingRadius(loadRestaurantsDuringPeakHours(), LocalTime.of(19, 0)));
  }
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    assertEquals("5.0", normalHoursServingRadius(loadRestaurantsDuringNormalHours(),
        LocalTime.of(18, 0)));
 
    //  assertFalse(false);
  }

  private String normalHoursServingRadius(List<Restaurant> restaurants, LocalTime timeOfService) {
    when(restaurantRepositoryServiceMock
        .findAllRestaurantsCloseBy(any(Double.class), any(Double.class), any(LocalTime.class),
            any(Double.class)))
        .thenReturn(restaurants);
 ...
 * 
 * For Example to test normalHourServingRadiusIs5Kms
 * ./gradlew test --tests RestaurantServiceTest.normalHourServingRadiusIs5Kms
 */
