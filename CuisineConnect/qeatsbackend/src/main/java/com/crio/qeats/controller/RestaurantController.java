...
public class RestaurantController {
   ...
   * restaurant.setName(removeAlphaNumeric((restaurant.getName()))); }
   */
...
/*
 * // @GetMapping(RESTAURANTS_API) // public ResponseEntity<GetRestaurantsResponse>
 * getRestaurants(@Valid GetRestaurantsRequest getRestaurantsRequest,BindingResult bindingResult) {
 * 
 * // // Check for validation error // if( bindingResult.hasErrors() ) { // return
 * ResponseEntity.badRequest().body(new GetRestaurantsResponse()); // }
 * 
 * // log.info("getRestaurants called with {}", getRestaurantsRequest); // GetRestaurantsResponse
 * getRestaurantsResponse;
 * 
 * // //CHECKSTYLE:OFF // getRestaurantsResponse = restaurantService //
 * .findAllRestaurantsCloseBy(getRestaurantsRequest, LocalTime.now()); //
 * log.info("getRestaurants returned {}", getRestaurantsResponse); // //CHECKSTYLE:ON
 * 
 * // return ResponseEntity.ok().body(getRestaurantsResponse); // }
 */
