...
public interface RestaurantRepositoryService {
   ...
   */
  @Async
  Future<List<Restaurant>> findRestaurantsByAttributesUsingMultithreading(Double latitude,
   ...
   */
  @Async
  Future<List<Restaurant>> findRestaurantByNameUsingMultithreading(Double latitude,
      Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms);    
   ...
   */    
  @Async
  Future<List<Restaurant>> findRestaurantsByItemNameUsingMultithreading(Double latitude,
      Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms);
   ...
   */
  @Async
  Future<List<Restaurant>> findRestaurantsByItemAttributesUsingMultithreading(Double
